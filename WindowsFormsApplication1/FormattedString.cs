...
namespace WindowsFormsApplication1
{
    ...
    "<TBODY>" +
		...
		"<TR>"+
			...
			"<TD STYLE=\"border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000\" ALIGN=LEFT>Punti Fatti</TD>"+
		...
		"<TR>"+
			...
			"<TD STYLE=\"border-left: 1px solid #000000\" ALIGN=LEFT><B><FONT FACE=\"Century\" SIZE=3><BR></FONT></B></TD>"+
			"<TD ALIGN=LEFT><BR></TD>"+
...
"<TABLE FRAME=VOID CELLSPACING=0 COLS=12 RULES=NONE BORDER=0>" +
   ...
   "<div id=\"H2\"  style=\"position:absolute; top:255px; left:700px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br><br></FONT></div>" +
   "<div id=\"H4\"  style=\"position:absolute; top:115px; left:470px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H6\"  style=\"position:absolute; top:395px; left:470px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H8\"  style=\"position:absolute; top:45px ; left:240px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H10\" style=\"position:absolute; top:185px; left:240px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H12\" style=\"position:absolute; top:325px; left:240px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H14\" style=\"position:absolute; top:465px; left:240px; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br> <br> </FONT></div>" +
   "<div id=\"H16\" style=\"position:absolute; top:10px;  left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##1##<br> </FONT></div>" +
   "<div id=\"H18\" style=\"position:absolute; top:80px;  left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##2##<br> </FONT></div>" +
   "<div id=\"H20\" style=\"position:absolute; top:150px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##3##<br> </FONT></div>" +
   "<div id=\"H22\" style=\"position:absolute; top:220px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##4##<br> </FONT></div>" +
   "<div id=\"H24\" style=\"position:absolute; top:290px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##5##<br> </FONT></div>" +
   "<div id=\"H26\" style=\"position:absolute; top:360px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##6##<br> </FONT></div>" +
   "<div id=\"H28\" style=\"position:absolute; top:430px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##7##<br> </FONT></div>" +
   "<div id=\"H30\" style=\"position:absolute; top:500px; left:10px ; width:200px; height:60px; border:1px solid #000; \"><FONT SIZE=\"2\" COLOR=\"000000\"> <br>##8##<br> </FONT></div>" +
    "</body></html>";
